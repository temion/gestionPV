<?php
    ...
    $valeurs = array("null", $_GET['idRapport'], $_GET['equipement'], $_GET['discipline'], $_GET['controle'], $nouvelleVal, $_GET['controleur'], "false", "false", 0, "false", "false", "false", $bdd->quote(conversionDate($_GET['date_debut'])), $bdd->quote(conversionDate($_GET['date_fin'])), "null", "null", "null");
